...
class ChatInterface(Frame):
    ...
    def __init__(self, master=None):
        ...
        help_option.add_command(label="About AruBot", command=self.msg)
    ...
    def msg(self):
        tkinter.messagebox.showinfo("AruBot v1.0",
                                    'AruBot is a chatbot for answering health related queries\nIt can answer questions regarding the Arundati Hospital')

    def about(self):
        tkinter.messagebox.showinfo("AruBot Developers",
                                    "1.Vivek\n2.Aakash\n3.Jagadish\n4.Uday Kiran\n5.Yashwanth")
